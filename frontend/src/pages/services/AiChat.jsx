import Setu from "../../assets/aichat.jpg";
import SharedCard from "../../components/SharedCard";
import Data from "../../data/aiChatData";
            ...
            <section className="w-full bg-hero-gradient  pt-32  pb-24 rounded-b-[30px]">
                <div className="max-w-full lg:px-30 mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-10">
                    ...
                    <div className="w-full lg:w-1/2 space-y-5">
                        ...
                        <p className="text-justify">In today’s digital age, providing exceptional customer service is more important than ever. With Software Setu Chatbot services, you can revolutionize the way you interact with your customers, enhance engagement, and drive business growth.</p>
