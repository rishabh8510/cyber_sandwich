import Setu from "../../assets/virtual.jpg";
            ...
            <section className="w-full bg-hero-gradient  pt-32  pb-24 rounded-b-[30px]">
                <div className="max-w-full lg:px-30 mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-10">
                    ...
                    <div className="w-full lg:w-1/2 space-y-5">
                        ...
                        <p className="text-justify">Cyber Sandwich offers Virtual Assistant services powered by advanced artificial intelligence technology. Our Virtual Assistant service provides businesses with intelligent, responsive, and versatile support, enabling them to streamline operations, boost productivity, and focus on core business activities.</p>
                        <NavLink to="/contact">
